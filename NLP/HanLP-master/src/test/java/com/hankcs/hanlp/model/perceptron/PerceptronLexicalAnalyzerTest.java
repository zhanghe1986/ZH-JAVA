...
public class PerceptronLexicalAnalyzerTest extends TestCase
{
    ...
    {
        analyzer = new PerceptronLexicalAnalyzer(com.hankcs.hanlp.traininfer.Config.CWS_MODEL_FILE, com.hankcs.hanlp.traininfer.Config.POS_MODEL_FILE, Config.NER_MODEL_FILE);
    }
