...
import com.hankcs.hanlp.traininfer.Config;
...
public class CWSTrainerTest extends TestCase
{
    ...
    public void testTrain() throws Exception
    {
        ...
        PerceptronTrainer.Result result = trainer.train(
                ...
                com.hankcs.hanlp.traininfer.Config.CWS_MODEL_FILE
        );
...
//        Segment segmenter = new AveragedPerceptronSegment(POS_MODEL_FILE);
    ...
    {
        PerceptronSegmenter segmenter = new PerceptronSegmenter(com.hankcs.hanlp.traininfer.Config.CWS_MODEL_FILE);
    ...
    {
        Segment segmenter = new PerceptronLexicalAnalyzer(com.hankcs.hanlp.traininfer.Config.CWS_MODEL_FILE, com.hankcs.hanlp.traininfer.Config.POS_MODEL_FILE);
        System.out.println(segmenter.seg(SENTENCE));
    }

    public void testCWSandPOSandNER() throws Exception
    {
        PerceptronLexicalAnalyzer segmenter = new PerceptronLexicalAnalyzer(com.hankcs.hanlp.traininfer.Config.CWS_MODEL_FILE, com.hankcs.hanlp.traininfer.Config.POS_MODEL_FILE, Config.NER_MODEL_FILE);
